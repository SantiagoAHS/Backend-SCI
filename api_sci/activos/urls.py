...
from .views import TipoActivoListCreateView, ActivoCreateView, TipoActivoDeleteView, ActivoListView, ActivoDeleteView, DashboardStatsView, ReporteActivosExcelView, ReporteActivosPDFView, ActivoDetailView, DescargarQRActivosView, ReporteActivosPorAreaPDFView, ActivoDisponibleListView
